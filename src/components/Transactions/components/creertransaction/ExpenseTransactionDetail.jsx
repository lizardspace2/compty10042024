...
import { SimpleGrid, Heading, Tag } from '@chakra-ui/react';
...
const ExpenseTransactionDetail = () => {
  // State and functions for ExpenseInformation
  ...
  // State and functions for ExpenseVentilationComponent
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* ExpenseVentilationComponent Component */}
